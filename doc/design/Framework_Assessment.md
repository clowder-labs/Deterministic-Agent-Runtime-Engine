...
existing design docs under `doc/design/modules/` and `doc/design/Interfaces.md`.
It focuses on:
...
3. **Domain boundary conventions are uneven**
   ...
   - Impact: unclear API stability surface; inconsistent with
     `doc/design/Interfaces.md` structure rules.
...
3. **Doc alignment pass**
   - Update module design docs and `doc/design/Interfaces.md` to match reality.
