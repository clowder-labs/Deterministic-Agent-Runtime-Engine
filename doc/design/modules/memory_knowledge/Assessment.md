...
- `doc/design/modules/memory_knowledge/README.md`: reflect default implementations + factory path.
- `doc/design/Framework_MinSurface_Review.md`: align memory/knowledge exposure lists.
