...
- **Hooks 未被触发**：Hook 体系仅有接口与组合器，未被 DareAgent 调用（TODO）。
...
| hook | DareAgent 未触发 hooks | 中 | `doc/design/modules/hook/README.md` | TODO | 未开始 |
...
> 现状说明：Hook 接口与组合器已存在，但 DareAgent 尚未触发 hook（TODO）。
