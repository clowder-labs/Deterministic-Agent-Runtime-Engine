...
from dare_framework3_4.tool.interfaces import IToolGateway
from dare_framework3_4.tool.component import ICapabilityProvider
from dare_framework3_4.tool.types import CapabilityDescriptor
...
class DefaultToolGateway(IToolGateway):
    ...
    def register_provider(self, provider: object) -> None:
        ...
        self._providers.append(cast(ICapabilityProvider, provider))
