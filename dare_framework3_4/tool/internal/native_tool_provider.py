...
from dare_framework3_4.tool.interfaces import ITool, ICapabilityProvider
from dare_framework3_4.tool.types import CapabilityDescriptor, CapabilityType, ProviderStatus, RunContext
...
class NativeToolProvider(ICapabilityProvider):
    ...
    async def health_check(self) -> ProviderStatus:
        """Report provider health for gateway checks."""
        if self._tools:
