...
These types mirror the v2/v3 taxonomy used across the repo so v3.4 placeholder
interfaces can align with the v4.0 docs without committing to concrete policy
