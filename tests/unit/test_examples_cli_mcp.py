...
@pytest.mark.asyncio
async def test_handle_approvals_command_requires_typed_action_payload_in_response_mcp_cli() -> None:
    cli_mcp = _load_cli_module(
...
@pytest.mark.asyncio
async def test_handle_approvals_command_requires_dict_action_result_mcp_cli() -> None:
    cli_mcp = _load_cli_module(
