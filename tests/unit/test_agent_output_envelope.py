...
class _ToolThenFinalWithEmptyUsageModel:
    def __init__(self) -> None:
        self._responses = [
            ModelResponse(
                content="calling tool",
            ...
            ModelResponse(content="final response", tool_calls=[], usage={}),
        ]
        self._idx = 0
...
@pytest.mark.asyncio
async def test_react_agent_final_reply_with_empty_usage_keeps_latest_usage() -> None:
    agent = ReactAgent(
