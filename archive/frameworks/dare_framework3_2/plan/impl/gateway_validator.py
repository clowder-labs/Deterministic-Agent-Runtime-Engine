...
from dare_framework3_2.plan.component import IValidator
...
from dare_framework3_2.tool.types import RiskLevel

if TYPE_CHECKING:
    from dare_framework3_2.tool.component import IToolGateway
    from dare_framework3_2.tool.types import CapabilityDescriptor
