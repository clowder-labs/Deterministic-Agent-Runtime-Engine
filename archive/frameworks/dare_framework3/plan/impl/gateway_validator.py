...
from dare_framework3.plan.component import IValidator
...
if TYPE_CHECKING:
    from dare_framework3.tool.component import IToolGateway
    from dare_framework3.tool.types import CapabilityDescriptor
