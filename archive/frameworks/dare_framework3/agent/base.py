...
if TYPE_CHECKING:
    ...
    from dare_framework3.context.component import IContextManager, IResourceManager
    from dare_framework3.context.types import Budget
    from dare_framework3.event.component import IEventLog
    ...
    from dare_framework3.tool.component import ITool, IToolGateway, IProtocolAdapter, IExecutionControl
