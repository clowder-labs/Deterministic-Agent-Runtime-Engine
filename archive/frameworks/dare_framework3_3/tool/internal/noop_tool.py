...
from dare_framework3_3.tool.component import ITool
from dare_framework3_3.security.types import RiskLevel
from dare_framework3_3.tool.types import Evidence, RunContext, ToolResult, ToolType
from dare_framework3_3.utils.ids import generate_id


class NoOpTool(ITool):
    """A no-op tool for default wiring.
    ...
    def description(self) -> str:
        return "No-op tool for default wiring."
