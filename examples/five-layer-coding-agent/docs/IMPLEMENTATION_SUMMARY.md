...
**File**: `model_adapters/openrouter.py`
...
- ✅ model_adapters/openrouter.py - tool_calls extraction implemented
...
**Modified**:
- `model_adapters/openrouter.py` - Added tool_calls extraction
