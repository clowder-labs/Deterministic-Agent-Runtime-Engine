"""Run context state for bridging runtime to tool contexts."""
...
from dare_framework3_2.tool.types import RunContext


@dataclass
class RunContextState:
    """Bridges the Kernel runtime into tool execution contexts.
