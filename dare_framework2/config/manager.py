"""Config manager and helpers for layered configuration."""
...
from dare_framework2.config.models import Config
...
class ConfigManager:
    ...
    def reload(self) -> Config:
        """Reload configuration sources and return the effective Config."""
        self._refresh()
        return self._config
    ...
    def get_namespace(self, namespace: str) -> dict[str, Any]:
        """Return a nested namespace dictionary if present."""
