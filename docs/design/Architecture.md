...
|---|---|---|---|---|---|
| security | policy gate + trust derivation 未接入 Agent/Tool | 高 | `docs/design/modules/security/README.md` | TODO | 未开始 |
| plan | ValidatedPlan.steps 未驱动 Execute Loop | 高 | `docs/design/modules/plan/README.md` | TODO | 未开始 |
| hook | Hook payload schema 与扩展策略待完善 | 中 | `docs/design/modules/hook/README.md` | TODO | 进行中 |
| event | EventLog 默认实现缺失 | 中 | `docs/design/modules/event/README.md` | TODO | 未开始 |
| context | LTM/Knowledge 融合策略缺失 | 中 | `docs/design/modules/context/README.md` | TODO | 未开始 |
...
|---|---|---|---|
| agent | 编排策略承载域；对外最小运行面；支持多编排实现 | `dare_framework/agent/five_layer.py` | `docs/design/modules/agent/README.md` |
| context | 上下文核心实体（context-centric）；持有 STM/LTM/Knowledge 引用与 Budget；assemble 组装上下文 | `dare_framework/context/_internal/context.py` | `docs/design/modules/context/README.md` |
| tool | 能力目录（registry）与系统调用边界；Tool Loop 语义 | `dare_framework/tool/default_tool_manager.py` | `docs/design/modules/tool/README.md` |
...
| transport | Client ↔ Agent 交互协议（设计中） | `docs/design/modules/transport/*` | `docs/design/modules/transport/transport_mvp.md` |
