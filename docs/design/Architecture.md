...
|---|---|---|---|---|---|
| security | policy gate + trust derivation 未接入 Agent/Tool | 高 | `docs/design/module_design/security/README.md` | TODO | 未开始 |
| plan | ValidatedPlan.steps 未驱动 Execute Loop | 高 | `docs/design/module_design/plan/README.md` | TODO | 未开始 |
| hook | Hook payload schema 与扩展策略待完善 | 中 | `docs/design/module_design/hook/README.md` | TODO | 进行中 |
| event | EventLog 默认实现缺失 | 中 | `docs/design/module_design/event/README.md` | TODO | 未开始 |
| context | LTM/Knowledge 融合策略缺失 | 中 | `docs/design/module_design/context/README.md` | TODO | 未开始 |
...
> 各模块的详细设计文档位于 `docs/design/module_design/`，按域拆分，便于渐进完善。

- agent: `docs/design/module_design/agent/README.md`
- context: `docs/design/module_design/context/README.md`
- tool: `docs/design/module_design/tool/README.md`
- plan: `docs/design/module_design/plan/README.md`
- model（总体）：`docs/design/module_design/model/README.md`
- model（Prompt）：`docs/design/module_design/model/Model_Prompt_Management.md`
- security: `docs/design/module_design/security/README.md`
- event: `docs/design/module_design/event/README.md`
