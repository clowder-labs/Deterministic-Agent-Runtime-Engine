...
The runtime SHALL orchestrate the five-layer loop (Session, Milestone, Plan, Execute, Tool) as defined in `docs/design/archive/Architecture_Final_Review_v1.3.md`, delegating to IPlanGenerator, IValidator, IPolicyEngine, IToolRuntime, and IRemediator.
