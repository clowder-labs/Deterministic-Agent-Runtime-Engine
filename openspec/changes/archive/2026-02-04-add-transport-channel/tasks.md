...
- [x] 1.6 Update transport design doc (`docs/design/module_design/transport/transport_mvp.md`) to reflect channel contracts, lifecycle, error handling, and usage examples.
- [x] 1.7 Archive redundant transport design docs and update `docs/design/Architecture.md` + `docs/design/module_design/README.md` references.
