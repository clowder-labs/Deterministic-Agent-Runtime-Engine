...
## Why
The authoritative v2 architecture (`docs/design/archive/Architecture_Final_Review_v2.1.md`, based on v2.0) positions `dare_framework/core/` as the Kernel (Layer 0) with stable contracts and a minimal, auditable closed-loop flow.
...
- **Tool Loop boundary cleanup**:
  - Split “execution boundary” (`Envelope`) from “tool invocation payload” (e.g., `ToolLoopRequest`) to resolve the current inconsistency in `docs/design/archive/Architecture_Final_Review_v2.0.md` and make security-critical fields derivable from trusted sources.
...
- **Documentation alignment**:
  - Add `docs/design/archive/Architecture_Final_Review_v2.1.md` (do not edit v2.0) and place architecture clarifications/adjustments there.
...
- Affected docs: `docs/design/archive/Architecture_Final_Review_v2.0.md` (if we choose to resolve the Envelope inconsistency there), `openspec/project.md`, and developer architecture docs.
- **BREAKING**: internal import paths change; compatibility is explicitly out of scope for this project phase.

## References
- `docs/design/archive/Architecture_Final_Review_v2.1.md`
