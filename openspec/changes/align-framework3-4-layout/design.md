...
- Goals:
  ...
  - Provide interface declarations consistent with `doc/design/Interfaces_v4.0.md` (agent/context/tool + placeholders for plan/security/event/hook/config).
...
- Decision: Add placeholder domains for `plan`, `security`, `event`, `hook`, and `config`.
  - Rationale: `doc/design/Interfaces_v4.0.md` describes these domains as part of the target interface surface; placeholders allow early alignment without committing to runtime behavior.
