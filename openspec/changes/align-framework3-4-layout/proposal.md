...
- Update `doc/design/DARE_v4.0_evidence.yaml` source paths if this change moves any evidence-referenced v3.4 files.

## Impact
- Affected code: `dare_framework3_4/` (directory structure + interface declarations; may change module paths).
- Affected docs: `doc/design/DARE_v4.0_evidence.yaml` (may require path updates to keep evidence valid).
