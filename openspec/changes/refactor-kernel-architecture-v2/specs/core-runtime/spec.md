...
### Requirement: Five-Layer Orchestration as Kernel Skeleton (v2)
...
### Requirement: Plan Attempt Isolation (v2)
...
### Requirement: HITL Gate Between Plan and Execute (v2)
...
### Requirement: Auditable Event Logging (v2)
