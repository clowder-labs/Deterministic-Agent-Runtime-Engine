...
- Documentation:
  - `doc/design/modules/transport/transport_mvp.md` is the canonical transport design doc.
  - Archive `doc/design/modules/transport/Transport_Domain_Design.md`, `InteractionStreaming.md`, and `Interaction_Design_Discussion.md`.
  - Update `doc/design/Architecture.md` and `doc/design/modules/README.md` to reference the canonical doc.
