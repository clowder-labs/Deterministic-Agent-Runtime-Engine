...
## Purpose
Define the canonical default event-log persistence behavior for `dare_framework/event`, including append-only storage, deterministic replay, and integrity verification.
